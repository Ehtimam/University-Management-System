...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icon/icon3.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icon/icon4.jpg"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icon/icon14.jpg"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icon/icon5.png"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icon/icon6.png"));
        ...
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icon/icon8.png"));
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icon/icon9.png"));
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icon/icon10.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icon/icon11.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("New Student Admission")){
            ...
            try{
                Runtime.getRuntime().exec("C:\\Users\\ASUS\\AppData\\Local\\Mozilla Firefox\\firefox.exe");
            }catch(Exception e){ }
